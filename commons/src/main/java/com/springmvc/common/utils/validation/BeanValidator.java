...
import com.springmvc.common.utils.validation.constraints.Length;
import com.springmvc.common.utils.validation.constraints.NotBlank;
import com.springmvc.common.utils.validation.constraints.NotEmpty;
import com.springmvc.common.utils.validation.constraints.NotNull;
import com.springmvc.common.utils.validation.rule.ErrorMessage;
import com.springmvc.common.utils.validation.rule.RuleUtils;
	...
	private Map<String, String> validate(Annotation[] rules, Method method,
		...
		if (isPrimitiveObjectType(method.getReturnType())) {
			...
			for (Annotation rule : rules) {
				...
				if (rule.annotationType() == com.springmvc.common.utils.validation.constraints.Number.class) {
					if (!RuleUtils.isNull(value)) {
						com.springmvc.common.utils.validation.constraints.Number number = (com.springmvc.common.utils.validation.constraints.Number) rule;
